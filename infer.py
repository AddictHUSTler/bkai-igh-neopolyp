...
def load_eval_model(device):
    ...
    checkpoint = torch.load('unet_model (1).pth',weights_only=False, map_location=device)
    # Fix "module."
...
parser = argparse.ArgumentParser(description="Inference script for UNet++ with EfficientNet encoder.")
